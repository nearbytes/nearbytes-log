import type { Hash as HashType, SerializedEvent, SignedEvent } from 'nearbytes-crypto';
...
export class EventLog {
  ...
  private channelPath(publicKey: PublicKey): string {
    return this.pathMapper(publicKey);
  }

  private eventPath(publicKey: PublicKey, eventHash: HashType): string {
